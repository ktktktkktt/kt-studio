      ...
      <div className="container-custom section-padding">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/services/consultation" className="text-gray-400 hover:text-white transition-colors">Консультации</Link></li>
              <li><Link to="/services/development" className="text-gray-400 hover:text-white transition-colors">Разработка</Link></li>
              <li><Link to="/services/support" className="text-gray-400 hover:text-white transition-colors">Поддержка</Link></li>
              <li><Link to="/services/training" className="text-gray-400 hover:text-white transition-colors">Обучение</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <a href="tel:+7" className="text-gray-400 hover:text-white transition-colors">
                  +7 (___) ___-__-__
                </a>
              </div>
              <div className="flex items-center">
                <Mail className="w-5 h-5 mr-3 text-accent" />
                <a href="mailto:info@tkachenko-kirill.ru" className="text-gray-400 hover:text-white transition-colors">
              ...
              <div className="flex items-start">
                ...
                <span className="text-gray-400">г. Москва, Россия</span>
              </div>
            </div>
          </div>
        </div>
