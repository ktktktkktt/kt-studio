        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/services" className="text-muted-foreground hover:text-foreground transition-colors">Услуги</Link></li>
              <li><Link to="/about" className="text-muted-foreground hover:text-foreground transition-colors">О компании</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/services/consultation" className="text-muted-foreground hover:text-foreground transition-colors">Консультации</Link></li>
              <li><Link to="/services/development" className="text-muted-foreground hover:text-foreground transition-colors">Разработка</Link></li>
              <li><Link to="/services/support" className="text-muted-foreground hover:text-foreground transition-colors">Поддержка</Link></li>
              <li><Link to="/services/training" className="text-muted-foreground hover:text-foreground transition-colors">Обучение</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <a href="tel:+7" className="text-muted-foreground hover:text-foreground transition-colors">
                  +7 (___) ___-__-__
                </a>
              </div>
              <div className="flex items-center">
                <Mail className="w-5 h-5 mr-3 text-accent" />
                <a href="mailto:info@tkachenko-kirill.ru" className="text-muted-foreground hover:text-foreground transition-colors">
              ...
              <div className="flex items-start">
                ...
                <span className="text-muted-foreground">г. Москва, Россия</span>
              </div>
            </div>
          </div>
        </div>
