        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center bg-card rounded-2xl p-8 shadow-sm">
              ...
              <div className="text-muted-foreground">Без критических инцидентов</div>
            </div>
            <div className="text-center bg-card rounded-2xl p-8 shadow-sm">
              <div className="text-4xl font-bold text-primary mb-2">+60%</div>
              <div className="text-lg font-semibold mb-2">Рост производительности</div>
              <div className="text-muted-foreground">Сотрудников банка</div>
            </div>
            <div className="text-center bg-card rounded-2xl p-8 shadow-sm">
              ...
              <div className="text-muted-foreground">Ранее ручных операций</div>
            </div>
          </div>
        </div>
      </section>
