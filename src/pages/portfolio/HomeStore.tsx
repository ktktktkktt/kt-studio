        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center bg-white rounded-2xl p-8 shadow-sm">
              ...
              <div className="text-gray-600">Благодаря 3D-просмотру товаров</div>
            </div>
            <div className="text-center bg-white rounded-2xl p-8 shadow-sm">
              <div className="text-4xl font-bold text-primary mb-2">-30%</div>
              <div className="text-lg font-semibold mb-2">Снижение возвратов</div>
              <div className="text-gray-600">Покупатели лучше понимают товар</div>
            </div>
            <div className="text-center bg-white rounded-2xl p-8 shadow-sm">
              <div className="text-4xl font-bold text-accent mb-2">+90%</div>
              <div className="text-lg font-semibold mb-2">Время на сайте</div>
              <div className="text-gray-600">Пользователи дольше изучают товары</div>
            </div>
          </div>
        </div>
      </section>
