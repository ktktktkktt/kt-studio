        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center bg-card rounded-2xl p-8 shadow-sm">
              ...
              <div className="text-muted-foreground">Увеличение количества обращений потенциальных клиентов</div>
            </div>
            <div className="text-center bg-card rounded-2xl p-8 shadow-sm">
              <div className="text-4xl font-bold text-primary mb-2">120%</div>
              <div className="text-lg font-semibold mb-2">Время на сайте</div>
              <div className="text-muted-foreground">Пользователи стали проводить больше времени на сайте</div>
            </div>
            <div className="text-center bg-card rounded-2xl p-8 shadow-sm">
              ...
              <div className="text-muted-foreground">По ключевым запросам в поисковой выдаче</div>
            </div>
          </div>
        </div>
      </section>
