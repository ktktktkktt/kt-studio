        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-20">
            <div className="lg:col-span-2">
              <h3 className="text-2xl font-bold mb-6 text-foreground">Философия работы</h3>
              <div className="space-y-4 text-muted-foreground">
                ...
                <div className="bg-muted rounded-lg p-6 mt-6">
                  <h4 className="font-semibold text-lg mb-3 text-foreground">Наши принципы:</h4>
          ...
          <div className="bg-gradient-to-br from-muted/30 to-primary/5 rounded-2xl p-8 mb-20">
            <h3 className="text-2xl font-bold text-center mb-8 text-foreground">Технологии и навыки</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="bg-card rounded-xl p-6 shadow-sm border">
                  <h4 className="font-semibold text-lg mb-4 text-card-foreground">Frontend</h4>
              ...
              <div className="text-center">
                <div className="bg-card rounded-xl p-6 shadow-sm border">
                  <h4 className="font-semibold text-lg mb-4 text-card-foreground">Backend</h4>
                  <div className="space-y-2 text-sm text-muted-foreground">
              ...
              <div className="text-center">
                <div className="bg-card rounded-xl p-6 shadow-sm border">
                  <h4 className="font-semibold text-lg mb-4 text-card-foreground">Другие навыки</h4>
                  <div className="space-y-2 text-sm text-muted-foreground">
          ...
          <div className="text-center mb-20">
            <h3 className="text-2xl font-bold mb-8 text-foreground">Достижения и сертификаты</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-card rounded-xl p-6 shadow-sm border-2 border-accent/20">
                <div className="text-3xl font-bold text-accent mb-2">150+</div>
                <div className="text-sm text-muted-foreground">Реализованных проектов</div>
              </div>
              <div className="bg-card rounded-xl p-6 shadow-sm border-2 border-primary/20">
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center">
                    <span className="text-accent mr-2">✓</span>
                    <span className="text-foreground">Качество превыше скорости</span>
                  </div>
                  <div className="flex items-center">
                    <span className="text-accent mr-2">✓</span>
                    <span className="text-foreground">Прозрачность в работе</span>
                  </div>
                  <div className="flex items-center">
                    <span className="text-accent mr-2">✓</span>
                    <span className="text-foreground">Долгосрочные отношения</span>
                  </div>
                </div>
              </div>
              
              <div>
                <h3 className="text-2xl font-bold mb-4 text-foreground">Наше видение</h3>
                <p className="text-muted-foreground mb-6">
                ...
                <div className="bg-background rounded-lg p-4 border">
                  <h4 className="font-semibold mb-2 text-foreground">Мы стремимся:</h4>
